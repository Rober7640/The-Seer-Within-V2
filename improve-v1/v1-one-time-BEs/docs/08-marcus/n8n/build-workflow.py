...
guard=code('Configuration and guard',"""const config = { enabled: false, backendBaseUrl: '', standardHours: 24, expeditedHours: 12, bumpCents: 1277, replicateModel: 'resemble-ai/chatterbox-turbo', voiceReferenceUrl: '', voiceVersion: 'marcus-voice-v2-10s', audioConfigVersion: 'marcus-audio-v1', audioTimeStretchRatio: 0.90, paragraphPauseMs: 300, cardSectionPauseMs: 600, closingPauseMs: 900, audioSharesOrderDeadline: true };
