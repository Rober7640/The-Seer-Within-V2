...
- The remote Marcus canvas now has a working nine-node Stage 1 manual PDF lane and a clearly parked Stage 2 production lane. The 47-node local scaffold remains an architecture reference.
