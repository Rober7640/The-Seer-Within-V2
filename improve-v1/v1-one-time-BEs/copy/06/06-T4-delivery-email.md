...
this email's only job is confirming that and reminding her, briefly, what to do when it lands.

⚠ **It does not re-run the letter.** She already read the full mythology — the court, the sealing,
...
- **No re-sell, no CTA.** The tracking link is the one link in this email, and it's functional,
  ...
  mention. That belongs in a separate send, after she's had the object in hand for a while, not
  here.
...
- **The ritual line is short on purpose.** Left wrist / never right, one sentence, seal it — the
  three facts she actually needs the moment the box is open. Everything else from Beat 6 and 8 of
...
- **"You'll find a few blank papers in the box"** reflects the real packaging spec (D7-equiv,
  `docs/06/0-WORKFLOW-06.md`) — 4–5 blank inserts ship in the box and she picks one, not a
  personalized single insert. Stated as a small practical fact, not explained further; she doesn't
