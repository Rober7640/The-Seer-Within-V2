...
const pages = [
  { name: 'booking (page-only)', url: `${BASE}/offers/wiccan/judgement-day`, expect: /judgement|open|agree|account|page/i },
  { name: 'shared upsell welcome1 (fake session → graceful)', url: `${BASE}/offers/upsell/welcome1?session_id=cs_test_fake123`, expect: /./ },
  { name: 'thank-you/Entry (fake session → generic)', url: `${BASE}/offers/wiccan/judgement-day/success?s=cs_test_fake123`, expect: /page is open|inbox|entry|reply/i },
];
