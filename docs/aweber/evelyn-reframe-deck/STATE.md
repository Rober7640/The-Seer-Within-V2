...
### Cycle 6 — LIVE (scheduled 2026-09-15 after explicit operator approval)

Fourteen emails, September 16–29 at 10:30 UTC / 6:30pm Malaysia and Singapore. All 13 configured daily lists: **182 scheduled broadcasts**, checked by reading each list back. Every send has a production `/e/<code>` link, exact recap/open-loop/continuation/big-idea content, and a live HTTP 302 to its matching `/evelyn` campaign. All 182 stored HTML/text bodies, subjects, send times and click tracking settings were also verified against the approved build. Full list-specific IDs: [cycle-6/broadcasts.json](sends/cycle-6/broadcasts.json).

Cycle 5's existing operator draft was preserved and is not counted here. No other broadcasts were cancelled or replaced.

| Send | Date | Fmt | Type | Reframe | Cast | State | Slug | Main-list AWeber ID |
|---|---|---|---|---|---|---|---|---|
| C6-1 | 2026-09-16 | 02 | insight | Learning every step before joining looks like preparation → it leaves out the adjustments that can only be learned with another person. | F | B | reframe-c6-01-first-step | 61398173 |
| C6-2 | 2026-09-17 | 01 | conversion beat | "Should I apologise again?" → "Is there repair left to offer, or am I asking the hurt person to relieve my guilt?" | M | A | reframe-c6-02-another-apology | 61398188 |
| C6-3 | 2026-09-18 | 07 | interactive | The pale ring mark tells you whether to hold on or begin again → it records what your hand has worn, while your next choice needs information from your life now. | neutral | C | reframe-c6-03-ring-mark | 61398202 |
| C6-4 | 2026-09-19 | 06 | insight | One final conversation feels necessary for closure → making ordinary present decisions wait for it gives the absent person a say in when those decisions happen. | neutral | C | reframe-c6-04-last-conversation | 61398216 |
| C6-5 | 2026-09-20 | 05 | conversion beat | "Being realistic" can combine a known constraint with an untested prediction → the prediction borrows the fact's authority and closes an option before it is checked. | neutral | valve | reframe-c6-05-being-realistic | 61398229 |
| C6-6 | 2026-09-21 | 03 | insight | The Two of Cups identifies a destined person → its exchange invites attention to both offering care and allowing welcome care to be received. | neutral | B | reframe-c6-06-two-of-cups | 61398242 |
| C6-7 | 2026-09-22 | 04 | interactive | A requested gesture doesn't count as care → sometimes that rule disqualifies a willing response because the person needed information first. | neutral | A | reframe-c6-07-had-to-ask | 61398256 |
| C6-8 | 2026-09-23 | 02 | insight | Restarting after every wrong note looks like thorough practice → it gives the familiar beginning most of the attention while the difficult passage gets almost none. | M | valve | reframe-c6-08-first-four-bars | 61398271 |
| C6-9 | 2026-09-24 | 07 | interactive | An unexpected laugh means love or grief is fading → enjoyment answers what is happening in this moment, without measuring the whole relationship or loss. | neutral | C | reframe-c6-09-unexpected-laugh | 61398285 |
| C6-10 | 2026-09-25 | 01 | conversion beat | Do different hobbies mean we have nothing in common? → Can the life we might share make room for what matters to each of us? | F | B | reframe-c6-10-nothing-in-common | 61398299 |
| C6-11 | 2026-09-26 | 03 | insight | A card of skilled work can sound like an instruction to try harder at love → relationship repair needs participation from both people, not ever more polished effort from one. | neutral | A | reframe-c6-11-eight-of-pentacles | 61398312 |
| C6-12 | 2026-09-27 | 06 | insight | Never going to bed angry protects the relationship → making agreement a bedtime deadline can encourage surrender before understanding; a mutually agreed pause preserves the unfinished conversation. | neutral | A | reframe-c6-12-bedtime-rule | 61398325 |
| C6-13 | 2026-09-28 | 05 | conversion beat | A packed day after loss looks like being well supported → if ordinary needs have no place in it, activity is being asked to replace support. | neutral | C | reframe-c6-13-keeping-busy | 61398338 |
| C6-14 | 2026-09-29 | 04 | interactive | "I knew they'd say no" sounds like an accurate account of a declined invitation → repeating it can turn a refusal of one time into a judgment about being wanted. | neutral | B | reframe-c6-14-expected-no | 61398351 |

Coverage: A×4 / B×4 / C×4 / valve×2; women in C6-1/10, men in C6-2/8; conversion beats C6-2/5/10/13; interactive beats C6-3/7/9/14. Seven formats appear twice, with 5–8 days between repeats, following the recent seven-format daily rotation. The old approximate two-week no-repeat ideal is incompatible with fourteen daily sends using only seven formats.

All 14 passed mechanical and judgment QA; all layouts passed at 390px and 1280px. Stories and reader questions are explicitly illustrative; card applications are symbolic, with no claims of a personal draw or predicted outcome. Two of Cups and Eight of Pentacles art was inspected and both hosted images returned HTTP 200.

**Next batch:** cycle 7, earliest September 30 at 10:30 UTC (re-check the live schedule). Avoid the reframes, hooks, phrases and cards below; keep live links sourced from draft frontmatter.
